...
const PRODUCTS = [
  {
    ...
    images: ["img/jordan-puffer-hood-front.webp?v=2", "img/jordan-puffer-hood-back.webp?v=2", "img/jordan-puffer-collar-front.webp?v=2", "img/jordan-puffer-collar-back.webp?v=2"],
  ...
  },
  {
    ...
    images: ["img/diesel-tracksuit-front.webp?v=2", "img/diesel-tracksuit-back.webp?v=2"],
    colors: [C.black, C.graph, C.bone], sizes: CLOTHING_SIZES,
  ...
  },
  {
    ...
    images: ["img/nike-tracksuit-front.webp?v=2", "img/nike-tracksuit-back.webp?v=2"],
